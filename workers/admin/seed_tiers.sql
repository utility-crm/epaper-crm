...
('tier_local', 'Local Press', 10240, 10000, 3, 5, 4500, 18, 'yearly', '["10GB Cloud Storage", "10,000 Views/Day", "Custom Domain Mapping", "Standard Support"]'),
('tier_regional', 'Regional Edition', 30720, 50000, 5, 15, 14250, 18, 'yearly', '["Everything in Local Press", "Remove ePaperSpace Branding", "Metered Paywall Integration", "Automated Article Clipping", "Priority Support"]'),
