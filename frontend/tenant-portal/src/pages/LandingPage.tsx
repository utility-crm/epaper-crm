      ...
      <nav className="landing-nav">
        <div className="landing-container landing-nav__inner">
          ...
          <div className="landing-nav__links">
            ...
            <Link to="/portal/login" className="landing-btn landing-btn--outline">Login</Link>
        ...
        <div className="landing-container landing-hero__inner">
          <div className="landing-hero__text">
            ...
            <div className="landing-hero__actions">
              ...
              <Link to="/portal/login" className="landing-btn landing-btn--outline landing-btn--lg">
                Publisher Login
              </Link>
            </div>
          </div>
          ...
          <div className="landing-footer__grid">
            ...
            <div className="landing-footer__links-col">
              ...
              <ul className="landing-footer__link-list">
                ...
                <li><Link to="/signup">Publisher Signup</Link></li>
              </ul>
            </div>
            <div className="landing-footer__links-col">
